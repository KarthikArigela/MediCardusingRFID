         ...
         <div class="col-md-4" style="margin-top: 5%;right: 8%">
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              ...
              <form class="form-group" method="POST" action="idlog.php"></center>
              <div class="col-md-8"><textarea type="text" name="id" style="float:left;"id="getUID" onclick="idget()" class="form-control" placeholder="Place the Medi-Card *" rows="1" cols="1"></textarea></div>
              <div class="row">
                 <div class="col-md-10"  style="padding-left: 16px;margin-top:0%">
                    <input type="submit" id="inputbtn" name="pat2sub" style="float:right;"value="Login" class="btn btn-success">
                  </div>           
                </div> 
            </form>
            <center>
              <p style="font-family: 'IBM Plex Sans', sans-serif; margin-top: 5%">OR</p>
              <form class="form-group" method="POST" action="func.php">
                <div class="row" style="margin-top: 0%">
                
                  <div class="col-md-4" style="margin-top: 1%"><label>Email: </label></div>
                  <div class="col-md-8" style="margin-top: 1%"><input type="text" name="email" class="form-control" placeholder="Email" required/></div><br><br>
                ...
                <div class="row">
                 <div class="col-md-4"  style="padding-left: 160px;margin-top: 5%">
