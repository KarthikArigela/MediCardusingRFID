                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                        <textarea type="text" onclick="idget()" name="id" id="getUID" class="form-control one" placeholder="Place the Medi-Card *"  rows="1" cols="1" ></textarea>
                                       <!-- <button type="button" class="btnTap" onclick="idget()">Tap</button>
--></div>
